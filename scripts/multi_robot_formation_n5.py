...
follower_3 = Articulation("/robile_follower_3/base_link")
follower_4 = Articulation("/robile_follower_4/base_link")

leader.initialize()
follower_1.initialize()
follower_2.initialize()
follower_3.initialize()
follower_4.initialize()

fleet = [leader, follower_1, follower_2, follower_3, follower_4]

GOAL_X = 5.0
TOLERANCE = 0.1

csv_path = os.path.expanduser(
    "~/isaac_projects/robile_assignment/scripts/isaacsim_fleet_data_n5.csv"
)
csv_data = [
    [
        "frame",
...
def on_update(event):
    ...
    f3_pos, _ = follower_3.get_world_poses()
    f4_pos, _ = follower_4.get_world_poses()
...
subscription = stream.create_subscription_to_pop(on_update, name="FleetNavigation_N5")
